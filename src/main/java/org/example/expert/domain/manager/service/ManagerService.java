...
public class ManagerService {
    ...
    public ManagerSaveResponse saveManager(AuthUser authUser, long todoId, ManagerSaveRequest managerSaveRequest) {
        ...
        Long targetManagerUserId = managerSaveRequest.getManagerUserId();
        ...
        try {
            ...
            // 성공 로그 저장
            managerLogService.saveSuccessLog(user.getId(), todoId, targetManagerUserId);
            ...
            // 실패 로그 저장
            managerLogService.saveFailedLog(user.getId(), todoId, targetManagerUserId, e.getMessage());
